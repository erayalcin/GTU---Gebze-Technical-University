...
\newline
\newline Basic Step:Apply n=1 on the equation.We prove that equation is true for n=1
\newline $\frac{3(5^{2} - 1)}{4}$=18 
\newline
\newline Inductive Step: Equation of n=k is true
\newline n=k 
\newline3+3.5+3. $5^2$+...+3 . $5^k$=$\frac{3(5^{k+1} - 1)}{4}$=a 
\newline
\newline  Apply n=k+1
\newline 3+3.5+3. $5^2$+...+3 . $5^k$+(3 . $5^{k+1})$=$\frac{3(5^{k+2} - 1)}{4}$ \newline 
\newline a+(3 . $5^{k+1})$=$\frac{3(5^{k+2} - 1)}{4}$
\newline
\newline (3 . $5^{k+1})$=$\frac{3(5^{k+2} - 1)}{4}$-$\frac{3(5^{k+1} - 1)}{4}$
\newline
\newline (3 . $5^{k+1})$ =$\frac{3(5^{k+1} - 1)(5-1)}{4}$
\newline
...
\newline b)  b=[2, 3]
\newline
\newline c)  c=$\{$4, 2, 5$\}$ (It can be written as $\{$4, 2, 5$\}$ Because we do not repeat the elements while writing the elements of a set. )\newline
\newline d)  d=$\{$4, 5, 7, 2$\}$ - $\{$5, 7$\}$ =$\{$4, 2$\}$ (The difference of A and B)
\newline
\newline e)  e=$\{$4, 2$\}$
\newline
\newline
