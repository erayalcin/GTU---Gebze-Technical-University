...
\solution
\newline = $a_{n-1}$ = $-2^{n+1-1}$   \xrightarrow[ ] {}    $a_{n-1}$ = $-2^{n}$
\newline = 3$a_{n-1}$ + $2^n$ = 3($-2^{n}$)+$2^{n}$
\newline = -3.$2^{n}$+$2^{n}$
\newline = $2^{n}$(-3+1) = $2^{n}$.-2
\newline = $-2^{n+1}$ =  $a_n$ 
\newline $a_n$ = $-2^{n+1}$ is a solution of the recurrence relation $a_n$ = 3$a_{n-1}$ + $2^n$
\subproblem{b} Find the solution with $a_0$ = 1.
\solution
\newline $a_n$=r implies $a_n$ = 3$a_{n-1}$ + $2^n$
\newline r=3.$r^0$+0 
\newline r=3
the solution is    $a_n$=\alpha . $3^{n}
\newline $a_n$(h)=\alpha . $3^{n}$-$2^{n+1}$
\newline $a_0$=\alpha .$3^{0}$-$2^{1}$ then $a_0$=1
\newline 1=\alpha -2 
\newline =\alpha=3
...
\newline $r^2$=2$r^$-2 
\newline $r^2$-2$r^$+2 = 0
\newline {\qf}{$r=\frac{-b\pm\sqrt{b^2-4ac}}{2a}$}
\newline {\qf}{$r=\frac{-(-2)\pm\sqrt{(-2)^2-4.1.2}}{2.1}$}
\newline r = 1 $\pm i$
